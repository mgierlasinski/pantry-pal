...
public class AppiumSetup : IDisposable
{
    ...
    public AppiumSetup()
    {
        ...
        androidOptions.AddAdditionalAppiumOption(AndroidMobileCapabilityType.AppPackage, "com.pantrypal.mobile");

        //Make sure to set [Register("com.companyname.applicationname")] on the MainActivity of your android application
        androidOptions.AddAdditionalAppiumOption(AndroidMobileCapabilityType.AppActivity, "crc645e3cce8ffe39a791.MainActivity");
