...
public class RegisterPageViewModelTests
{
    ...
    public async Task RegisterAsync_InvalidInput_HasValidationErrors(string email, string password, string confirmPassword, params string[] expectedErrors)
    {
        // Arrange
    ...
    [InlineData("invalid-email", "", "password123", "Please enter a valid email address.", "Password is required.")]
    [InlineData("", "password123", "", "Email is required.", "Please confirm your password.")]
    public async Task RegisterAsync_InvalidEmailFormat_HasValidationErrors(string email, string password, string confirmPassword, params string[] expectedErrors)
    {
        // Arrange
        _viewModel.Email = email;
        _viewModel.Password = password;
    ...
    [InlineData("test@example.com", "", "", "Password is required.", "Please confirm your password.")]
    public async Task RegisterAsync_PasswordTooShort_HasValidationErrors(string email, string password, string confirmPassword, params string[] expectedErrors)
    {
        // Arrange
        _viewModel.Email = email;
        _viewModel.Password = password;
